...
namespace Pulumi.Picasso
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Picasso.version.txt");
    ...
    internal sealed class PicassoResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public PicassoResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
